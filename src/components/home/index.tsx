        ...
        <div className = "main">
            <div className='customModal container-sm'>
                <div className='wrap-basic-info'>
                    <div className = "row">
                        <div className='info-left col-12 col-md-8'>
                            ...
                            <div className='wrap-info-basic'>
                                <ul>
                                    <li>- Tôi tên là Thông ( Pine ) có thể xem tôi như là một con kiến nhỏ </li>
                                    <li>- Một con kiến chăm chỉ cần cù ... Một con kiến trong sa mạc</li>
                                    <li>- Nhỏ bé vô cùng {"<>"} Nhưng lại mang nghị lực để vượt cạn</li>
                                </ul>
                            </div>
                        </div>
                        <div className='info-right col-12 col-md-4'>
