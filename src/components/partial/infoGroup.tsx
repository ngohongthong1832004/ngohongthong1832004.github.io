        ...
        <div className='group-info'>
            <div className="wrap-img-name">
                ...
                <div className="wrap-name">
                    <h3 className="name-project">3Trees</h3>
            ...
            <div className="info">
                <div className="wrapper">
                    ...
                    <p className="text">React + redux + scss</p>
                </div>
                <div className="wrapper">
                    ...
                    <p className="text">Django ( RestFull API )</p>
                </div>
                <div className="wrapper">
                    <h4 className="name">- Database:</h4>
                    <p className="text">Sqlite3</p>
                </div>
                <div className="wrapper">
                    <h4 className="name">- Description:</h4>
                    <p className="text">Web film with some function : Auth / CRUD film / Like-Follow</p>
                </div>
            </div>
        </div>
    )
